...
<table width="1000" border="0" cellpadding="2" cellspacing="1" class="table-border">
  ...
  <tr>
    <td colspan="2"><a href="?page=Add-Pelaksana" target="_self"><img src="images/add.png" height="25" border="0" /></a></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
...
<?php 
 # UNTUK PAGING (PEMBAGIAN HALAMAN)
  ...
  $result 	= mysql_query("SELECT * FROM pelaksana_kegiatan");
  $total 	= mysql_num_rows($result);
  $pages 	= ceil($total/$halaman);            
  $query 	= mysql_query("SELECT * FROM pelaksana_kegiatan LIMIT $mulai, $halaman")or die(mysql_error);
  ...
  while ($userRow = mysql_fetch_array($query)) {
    ?>
      <tr>
        ...
        <td align="center"><a href="?page=Edit-Pelaksana&amp;Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data"><img src="images/edit.png" width="20" height="20" border="0" /></a></td>
        <td align="center"><a href="?page=Delete-Pelaksana&amp;Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN INGIN MENGHAPUS DATA PENTING INI ... ?')"><img src="images/delete.png" width="20" height="20"  border="0"  alt="Delete Data" /></a></td>
      </tr>
      <?php } ?>
    </table></td>
  </tr>
  ...
  <a href="?page=Data-Pelaksana&halaman=<?php echo $i; ?>"><?php echo $i; ?></a>
  <?php } ?>
	</td>
  </tr>
</table>
