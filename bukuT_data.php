...
<table width="1000" border="0" cellpadding="2" cellspacing="1" class="table-border">
  <tr>
    <td colspan="2" align="right"><h4><b>HASIL STUDI </b></h4></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2"><table class="table-list" width="100%" border="1" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="170"><b>NIM</b></th>
        <th width="170"><b>Nama</b></th>
        <th width="150"><b>KODE MATKUL</b></th>
        <th width="200"><b>NILAI TUGAS</b></th>
        <th width="170"><b>NILAI TTS</b></th>
        <th width="170"><b>NILAI TAS</b></th>  
     </tr>
  <?php
  ...
  ?>
	...
	<?php
	    for ($h = 1; $h <= $max; $h++) {
		$list[$h] = $row * $h - $row;
		echo " <a href='?page=Buku-Tamu&hal=$list[$h]'>$h</a> ";
	}
	?>
	</td>
  </tr>
